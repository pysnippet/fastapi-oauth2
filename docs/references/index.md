...
redirects to the authorization endpoint of the IDP with an autogenerated `state` parameter and stores it using the
configured [`state_backend`](/integration/configuration#statebackend). After authorization, when
